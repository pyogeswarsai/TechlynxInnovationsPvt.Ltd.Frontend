...
const History = () => {
  return (
    <section id="History" className="history-container d-flex align-items-center text-white">
      <motion.div
        className="container bg-white rounded-4 w-75 h-75 py-5 shadow"
        initial="hidden"
        whileInView="visible"
      ...
      >
        <motion.h1
          className="text-center mb-4 display-5 fs-1 text-dark"
          custom={1}
          variants={fadeInUp}
        >
          Our History 
        ...
        <motion.p className="fs-4 p-2 text-dark" custom={2} variants={fadeInUp}>
        ...
        <motion.p className="fs-4 p-2 text-dark" custom={3} variants={fadeInUp}>
        ...
        <motion.p className="fs-4 p-2 text-dark" custom={5} variants={fadeInUp}>
