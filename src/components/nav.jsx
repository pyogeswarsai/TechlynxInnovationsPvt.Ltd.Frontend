    ...
    <nav className="navbar navbar-expand-lg navbar-custom shadow-sm px-3 py-3 bg-white">
      <div className="container-fluid">
        ...
        <div className="d-flex align-items-center">
          <img src="/logo.jpg" alt="Company Logo" className="logo-img me-2" />
          ...
          <ul className="navbar-nav mx-auto gap-lg-4 gap-2">
            ...
            <li className="nav-item dropdown fw-bold fs-5">
              ...
              <ul className="dropdown-menu shadow" aria-labelledby="aboutDropdown">
                <li><Link  className="dropdown-item" to="/about-us">Meet our people</Link ></li>
                <li><Link  className="dropdown-item" to="/about-us">Our History</Link ></li>
                <li><Link  className="dropdown-item" to="/about-us">Core Values</Link ></li>
                <li><Link  className="dropdown-item" to="/about-us">Our Partners</Link ></li>
                <li><Link  className="dropdown-item" to="/about-us">Awards</Link ></li>
                <li><Link  className="dropdown-item" to="/about-us">News</Link ></li>
                <li><Link  className="dropdown-item" to="/about-us">Location</Link ></li>
              </ul>
            </li>
            <li className="nav-item dropdown fw-bold fs-5">
              ...
              <ul className="dropdown-menu shadow" aria-labelledby="servicesDropdown">
                <li><Link className="dropdown-item" to="/services">Full Stack Development</Link ></li>
                <li><Link  className="dropdown-item" to="/services">Bloack Chain</Link ></li>
                <li><Link  className="dropdown-item" to="/services">Cloud Transformation</Link ></li>
                <li><Link  className="dropdown-item" to="/services">AI Solutions</Link ></li>
              </ul>
            </li>

            <li className="nav-item dropdown fw-bold fs-5">
              <a className="nav-link dropdown-toggle" href="#" id="careersDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                Careers
              </a>
              <ul className="dropdown-menu shadow" aria-labelledby="careersDropdown">
                <li><Link className="dropdown-item" to="/careers#whyjoinus">Why Join Us</Link></li>
                <li><Link className="dropdown-item" to="/careers#hiring">Hiring Process</Link></li>
                <li><Link className="dropdown-item" to="/careers#jobopenings">Job Openings</Link></li>
              </ul>
            </li>
        ...
        <div className="d-flex align-items-center gap-2 gap-md-3 mt-3 mt-lg-0">
          ...
          <button className="btn btn-primary apply-button" onClick={scrollToJobOpenings}>Apply</button></Link>
